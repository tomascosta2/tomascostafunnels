          ...
          <div className="max-w-[900px] mx-auto">
            ...
            <div className="bg-[#0066ff] text-white max-w-[600px] mx-auto mt-4 rounded-[20px] text-[14px] text-center">
              ...
              <div className="border-4 border-[#0066ff] rounded-[20px] overflow-clip aspect-video mx-auto">
                <iframe id="panda-636f6d70-7708-49b0-b7e2-7fe437824055" src="https://player-vz-5c2adb98-6a4.tv.pandavideo.com.br/embed/?v=636f6d70-7708-49b0-b7e2-7fe437824055" allow="accelerometer;gyroscope;autoplay;encrypted-media;picture-in-picture" className="w-full h-full"></iframe>
