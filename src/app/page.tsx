          ...
          <div className="max-w-[900px] mx-auto">
            ...
            <div className="bg-[#0066ff] text-white max-w-[600px] mx-auto mt-4 rounded-[20px] text-[14px] text-center">
              ...
              <div className="border-4 border-[#0066ff] rounded-[20px] overflow-clip mx-auto">
                <iframe className="aspect-video" id="panda-636f6d70-867a-4d89-94f4-490366e1b5e0" src="https://player-vz-5c2adb98-6a4.tv.pandavideo.com.br/embed/?v=636f6d70-867a-4d89-94f4-490366e1b5e0" allow="accelerometer;gyroscope;autoplay;encrypted-media;picture-in-picture"></iframe>
